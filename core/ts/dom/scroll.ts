...
export class Scroll {
    ...
    public static callback(endPos: number, duration: number = 200, complete: (...args: any) => any = noop): void {
        if (Scroll.running) {
    ...
    private constructor(private endPos: number,
    ...
    private update(endPos: number, duration: number, complete: (...args: any) => any): Scroll {
        this.endPos = endPos;
