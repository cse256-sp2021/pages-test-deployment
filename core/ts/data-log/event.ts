...
export class BaseTrackerEvent<T> implements TrackerEvent {
    ...
    public get detail() { return this.custEv.detail; }
}

// tslint:disable-next-line: max-classes-per-file
export class ClickEvent extends BaseTrackerEvent<{x: number, y: number, id: string}> {
    constructor(x: number, y: number, id: string, eventInitDict?: CustomEventInit<{x: number, y: number, id: string}> | undefined) {
...
export class ButtonEvent extends BaseTrackerEvent<{key: string, id: string}> {
    constructor(key: string, id: string, eventInitDict?: CustomEventInit<{key: string, id: string}> | undefined) {
        super(ActionEnum.CLICK, eventInitDict);
        this.detail.key = key;
        this.detail.id = id;
    }
...
// tslint:disable-next-line: max-classes-per-file
export class HistoryEvent extends BaseTrackerEvent<{url: string, extra?: any}> {
    constructor(url: string, extra?: any, eventInitDict?: CustomEventInit<{url: string}> | undefined) {
