...
export class Slideshow {
    ...
    public static discardAll() { Slideshow.slideshows = []; }
    ...
    public plusSlide(n: number) { this.showSlide(this.slideIndex += n); }
    public minusSlide(n: number) { this.showSlide(this.slideIndex -= n); }
